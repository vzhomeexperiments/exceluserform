...
'========================================
' FUNCTION that set cell color from formula
'========================================
' add this code to the cell =HYPERLINK(SetRGB(L5,L2,L3,L4),"HOVER!")
' http://stackoverflow.com/questions/1426369/excel-set-background-colour-of-cell-to-rgb-value-of-data-in-cell
